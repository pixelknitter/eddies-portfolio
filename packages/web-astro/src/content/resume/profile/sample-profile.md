---
section: profile
title: 'Eddie Freeman — Senior Product Engineer'
...
Sample long-form summary. Loaded only behind `PUBLIC_SHOW_FIXTURES`, and only
when no real resume content is present — see `loadResume`.
